...
public final class EventHandlers {
    ...
    /**
     * Registers common events, called in {@link io.github.steveplays28.dynamictreesfabric.DynamicTreesFabric#DynamicTreesFabric()}.
     */
    public static void registerCommon() {
        MinecraftForge.EVENT_BUS.register(COMMON_EVENT_HANDLER);
        MinecraftForge.EVENT_BUS.register(SERVER_EVENT_HANDLER);

        if (ModList.get().isLoaded(io.github.steveplays28.dynamictreesfabric.DynamicTreesFabric.FAST_LEAF_DECAY)) {
