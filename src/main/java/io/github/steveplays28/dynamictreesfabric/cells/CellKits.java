...
public class CellKits {
    ...
    public static final CellKit DECIDUOUS = new CellKit(io.github.steveplays28.dynamictreesfabric.DynamicTreesFabric.resLoc("deciduous")) {
    ...
    public static final CellKit CONIFER = new CellKit(io.github.steveplays28.dynamictreesfabric.DynamicTreesFabric.resLoc("conifer")) {
    ...
    public static final CellKit ACACIA = new CellKit(io.github.steveplays28.dynamictreesfabric.DynamicTreesFabric.resLoc("acacia")) {
    ...
    public static final CellKit DARK_OAK = new CellKit(io.github.steveplays28.dynamictreesfabric.DynamicTreesFabric.resLoc("dark_oak")) {
    ...
    public static final CellKit BARE = new CellKit(io.github.steveplays28.dynamictreesfabric.DynamicTreesFabric.resLoc("bare")) {
    ...
    public static final CellKit PALM = new CellKit(io.github.steveplays28.dynamictreesfabric.DynamicTreesFabric.resLoc("palm")) {
    ...
    public static final CellKit NETHER_FUNGUS = new CellKit(io.github.steveplays28.dynamictreesfabric.DynamicTreesFabric.resLoc("nether_fungus")) {
