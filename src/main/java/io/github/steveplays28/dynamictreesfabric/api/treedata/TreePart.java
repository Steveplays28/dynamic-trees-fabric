package io.github.steveplays28.dynamictreesfabric.api.treedata;
...
public interface TreePart {
	 ...
	 */
	Cell getHydrationCell(BlockView reader, BlockPos pos, BlockState state, Direction dir, LeavesProperties leavesProperties);
	 ...
	 */
	int probabilityForBlock(BlockState state, BlockView reader, BlockPos pos, BranchBlock from);
	 ...
	 */
	int getRadiusForConnection(BlockState state, BlockView reader, BlockPos pos, BranchBlock from, Direction side, int fromRadius);
	 ...
	 */
	boolean shouldAnalyse(BlockState state, BlockView reader, BlockPos pos);
	 ...
	 */
	MapSignal analyse(BlockState state, WorldAccess world, BlockPos pos, @Nullable Direction fromDir, MapSignal signal);
	 ...
	 */
	Family getFamily(BlockState state, BlockView reader, BlockPos pos);
	 ...
	 */
	int branchSupport(BlockState state, BlockView reader, BranchBlock branch, BlockPos pos, Direction dir, int radius);
