 ...
 */
public class PreGenerationContext extends GenerationContext<WorldAccess> {
	 ...
	 */
	public PreGenerationContext(WorldAccess world, BlockPos rootPos, Species species, int radius, Direction facing, SafeChunkBounds bounds, JoCode joCode) {
